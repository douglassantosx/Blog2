...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            # mensagem
            flash(u"Usuário já existe, entre com o seu login e senha", 'error')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not user:
            # flash("e-Mail do usuário não encontrado")
            flash(u"e-Mail do usuário não encontrado", 'error')
            return redirect(url_for('login'))
            ...
            flash(u"Senha inválida, tente novamente", 'error')
